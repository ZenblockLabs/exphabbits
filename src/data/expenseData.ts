...
const novemberData: MonthData = {
  ...
  selfExpense: [
    { desc: "PG Rent", amount: 6000 },
    { desc: "Spotify expense", amount: 140 },
...
// 2024 September data
const sept2024Data: MonthData = {
  snacks: [30, 30, 95, 166],
  food: [120, 200, 219, 240, 1840],
  travellingCharge: [50, 75, 100],
  otherExpenses: [
    ...
    { desc: "chicken nuggets", amount: 200 },
  ...
  selfExpense: [
    { desc: "tea", amount: 30 },
    { desc: "pani puri", amount: 30 },
    { desc: "Bus charge", amount: 50 },
    { desc: "pain killer Tablet", amount: 50 },
    { desc: "dinner", amount: 50 },
    { desc: "Pass", amount: 75 },
    { desc: "cake", amount: 95 },
    { desc: "nati style Veg Biryani", amount: 120 },
    ...
    { desc: "GET Dinner party", amount: 1840 },
...
// 2024 October data
const oct2024Data: MonthData = {
  snacks: [70, 70, 140, 225, 338],
  food: [60, 232, 238, 240, 360, 2020],
  travellingCharge: [25, 35, 40, 100, 107, 130, 356],
  otherExpenses: [
    { desc: "Gobi", amount: 35 },
    ...
    { desc: "Tea treat", amount: 338 },
    { desc: "football", amount: 350 },
    { desc: "Amish Home party", amount: 360 },
    ...
    { desc: "Myside party", amount: 2020 },
    { desc: "Brand shirts", amount: 3000 },
  ],
  selfExpense: [
    { desc: "pass", amount: 25 },
    { desc: "pass", amount: 70 },
    { desc: "juice", amount: 70 },
    { desc: "Auto charge", amount: 107 },
    { desc: "Bus charge", amount: 130 },
    { desc: "Tea corner", amount: 135 },
    { desc: "Juice with pups", amount: 140 },
    { desc: "lunch", amount: 232 },
    { desc: "dinner", amount: 238 },
    { desc: "pizza with coke", amount: 240 },
...
// 2024 November data
const nov2024Data: MonthData = {
  snacks: [50, 60, 95, 170],
  food: [200, 810, 3175],
  travellingCharge: [30, 60, 356],
  otherExpenses: [
    { desc: "Paring charge", amount: 30 },
    { desc: "Garage", amount: 40 },
    { desc: "Jumki", amount: 50 },
    { desc: "Softy", amount: 50 },
    { desc: "Auto", amount: 60 },
  ...
  selfExpense: [
    { desc: "Bhagira movie", amount: 170 },
    { desc: "pizza", amount: 200 },
    { desc: "Slipper", amount: 250 },
    { desc: "Bus charge", amount: 356 },
    { desc: "Movie", amount: 500 },
    { desc: "Lunch", amount: 810 },
    { desc: "Food", amount: 3175 },
...
// 2024 December data
const dec2024Data: MonthData = {
  snacks: [113, 150, 227, 350, 560, 1373],
  food: [350, 600, 5028],
  travellingCharge: [60, 152],
  otherExpenses: [
    { desc: "Shampoo", amount: 10 },
    { desc: "milk", amount: 26 },
    ...
    { desc: "Bus charge", amount: 152 },
    { desc: "zepto", amount: 227 },
...
export const initialExpenseData: ExpenseData = {
  ...
  2024: {
    ...createEmptyYear(),
    September: { ...sept2024Data },
    October: { ...oct2024Data },
    November: { ...nov2024Data },
    December: { ...dec2024Data },
  },
};
